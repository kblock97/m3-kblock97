...
export default class SignInForm extends Component {
    ...
    handleSubmit(event) {
        ...
        console.log("\tPassword: " + this.state.p);
    ...
    render() {
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <label className="formSectionTitle">Email <br/>
                    <input type="text" className="inputBox1" placeholder="Your email"
                           name="email" value={this.state.email} onChange={this.handleChange}/>
                </label><br/><br/>

                <label className="formSectionTitle">
                    Password <br/>
                    <input type="text" className="inputBox1" placeholder="Your password"
